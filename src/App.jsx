...
const defaultClinicalSchedule = {
  ...
  June: { 2: ["🩺 Clinical"], 3: ["🩺 Clinical"], 11: ["🩺 Clinical"], 12: ["🩺 Clinical"], 18: ["🩺 Clinical"], 19: ["🩺 Clinical"], 25: ["🩺 Clinical"], 26: ["🩺 Clinical"] },
  July: { 7: ["🩺 Clinical"], 8: ["🩺 Clinical"], 14: ["🩺 Clinical"], 15: ["🩺 Clinical"], 21: ["🩺 Clinical"], 22: ["🩺 Clinical"], 30: ["🩺 Clinical"], 31: ["🩺 Clinical"] },
...
const weeklySchedule = [
  ...
  { week: "Week 7 — 6/22", focus: "Cell communication + care plan + SIM test-out", tasks: ["6/22 — Cell Communication WB", "6/22 — Comprehensive Care Plan #1", "6/22–6/28 — SIM Test-Out Week", "6/24 or 6/25 — Mandatory SIM Test-Out Class"] },
  { week: "Week 8 — 6/29", focus: "No workbook, but paperwork continues", tasks: ["Week of 6/29 — Seminar Presentation 3", "Clinical Week 6/29–7/5: No workbook due", "2 eval screenshots + 2 care plans"] },
