      ...
      try {
        ...
        if (snapshot.exists()) {
          ...
          if (userLocal) {
            ...
            setClinical(userLocal.clinical || { date: "", site: "", preceptor: "", cases: "", airway: "", meds: "", learning: "", review: "" });
      ...
      <div className="min-h-screen bg-slate-50 p-4 text-slate-900 md:p-8">
        <div className="mx-auto max-w-2xl space-y-6">
          <Card className="p-6">
            ...
            <p className="mt-3 text-slate-600">Sign in with your own Google account before editing. This keeps each student’s clinical schedule, checkboxes, assignments, and brain dump private.</p>
            <div className="mt-5 rounded-xl border border-slate-200 bg-slate-50 p-3 text-sm text-slate-700">
              {authLoading ? "Checking sign-in..." : cloudStatus}
            </div>
            <div className="mt-5">
              <ActionButton onClick={handleGoogleSignIn}>Sign in with Google</ActionButton>
            </div>
          </Card>
        </div>
      </div>
